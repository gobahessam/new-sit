...
//  $(".essam__title").click(function (event) {
//    if ($(".essam").hasClass("one")) {
//      $(".essam__title").not($(this)).removeClass("active");
//      $(".essam__text").not($(this).next()).slideUp(300);
//    }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.footer__top', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().find('.footer__memu-item', '.footer__memu-items2').slideToggle(600);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleText('Свернуть', 'Подробнее');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.item__top', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().find('.item__bottom').slideToggle(600);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('active');
});
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slider-container1", {
  slidesPerView: 1,
  spaceBetween: 3,
  loop: true,
  autoplay: {
